 ...
 * @author ASUS
 */
@WebServlet(name = "SearchFoodServlet", urlPatterns = {"/SearchFood"})
public class SearchFoodServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        List<FoodDTO> searchResults = null;
        try {
            searchResults = foodDAO.searchFood(keyword);
        } catch (ClassNotFoundException ex) {
            Logger.getLogger(SearchFoodServlet.class.getName()).log(Level.SEVERE, null, ex);
        }

        request.setAttribute("foodList", searchResults);
